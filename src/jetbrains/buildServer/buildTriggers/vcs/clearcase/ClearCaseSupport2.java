...
public class ClearCaseSupport2 extends ServerVcsSupport implements VcsPersonalSupport,
                                                                  ...
                                                                  CollectChangesByIncludeRules, BuildPatchByIncludeRules, TestConnectionSupport
{
  ...
  private final @Nullable ClearCaseStructureCache myCache;
    ...
    public ClearCaseSupport2() {
      myCache = null;
    }

    public ClearCaseSupport2(File baseDir) {
    if (baseDir != null) {
  ...
  public ClearCaseSupport2(SBuildServer server, ServerPaths serverPaths, EventDispatcher<BuildServerListener> dispatcher) {
